...
# Make sure you have intents enabled properly
...
booking_boost_channel_id = 1332771593331408947  # Replace with your actual channel ID
...
# Run the bot using the token from the environment variable for better security
